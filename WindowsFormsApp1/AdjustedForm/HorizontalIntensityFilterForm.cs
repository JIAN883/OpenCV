...
{
    public partial class HorizontalIntensityFilterForm : Form
    {
        ...
        public HorizontalIntensityFilterForm()
        {
            InitializeComponent();
        }

        public HorizontalIntensityFilterForm(Form1 topForm) : this()
        {
        ...
        private void HorizontalIntensityFilterForm_Load(object sender, EventArgs e)
        {
            Mat src = source.Clone();
            horizontalIntensityFilter(src.Data, src.Width, src.Height, true, false, out IntPtr dst);
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Mat src = source.Clone();
                horizontalIntensityFilter(src.Data, src.Width, src.Height, true, true, out IntPtr dst);
                Mat dstImage = new Mat(src.Height, src.Width, MatType.CV_8UC3, dst);
